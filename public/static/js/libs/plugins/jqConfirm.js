(function($, _) {
  ...
  tmpl = "<div class='popup-box'>			<h2 class='urb-stitle'>{{title}}</h2>			<p class='control mb30'>{{answer}}</p>			<div class='control'>				<a  class='btn-gray btn-standar' title='No' href='javascript:;'>No</a>     			<a title='Sí' class='btn-urb btn-standar' href='javascript:;'>Sí</a>			</div>		</div>";
